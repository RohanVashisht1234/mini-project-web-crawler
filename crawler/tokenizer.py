"""
crawler/tokenizer.py
────────────────────
Text tokenization pipeline — no NLTK download required.
Uses a built-in English stop-word list and a pure-Python Porter stemmer.

Pipeline: lowercase → keep alpha tokens → remove stop words → stem
"""
...
class _PorterStemmer:
    """Lightweight Porter Stemmer (steps 1–3). No downloads needed."""
...
class Tokenizer:
    ...
    def __init__(self):
        self._use_stemming = config.USE_STEMMING
